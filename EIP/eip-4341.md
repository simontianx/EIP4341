...
is particularly convenient if an non-fungible token is thought of as the basic
unit on a blockchain as proposed in [EIP-3754](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-3754.md), and NFTs with unicoded tokenIds can be grouped as carriers to transmit
meanings with emojis and for languages that are based on
...
[ERC721](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md) and [ERC1155](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1155.md), the ordering information is not retained.

In the new business scenarios that are opened up by EIP-3754, NFTs can carry
meanings with unicoded tokenIds. This is practically useful for emojis and
languages that are based on logographs.
...
This standard, therefore, aims to combine the two and introduce the interface
for keeping, transferring, and manageing ordered information of NFTs in batches.

To apply this standard on language systems, distinctions are made first. For
non-logographic languages such as English, although the same standard can be
...
meanings can be transmitted in just a few characters, this standard is therefore
particularly valuable. Emojis are similar with logographs and can be included as well.
