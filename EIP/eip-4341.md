...
blockchain and can carry abstract meanings with unicoded `tokenId`s. Transferring
...
of `unicode`s and is able to keep the ordering information in a batch of tokens.
...
decoded to restore the original sequence of `unicode`s. The phrase information
